...
require_once get_template_directory() . '/includes/api-ai-chat.php';

// Enqueue AI Chat Assets
add_action('wp_enqueue_scripts', function () {
  wp_enqueue_style('te-ai-chat-css', get_template_directory_uri() . '/assets/css/ai-chat.css', [], '1.0');
  wp_enqueue_script('te-ai-chat-js', get_template_directory_uri() . '/assets/js/ai-chat.js', [], '1.0', true);

  // Pass nonce/settings to JS if needed
  wp_localize_script('te-ai-chat-js', 'teChatSettings', [
    ...
    <div class="te-field-group">
      ...
      <select id="te_resistencia" name="te_resistencia">
        ...
        <option value="Muito Alta" <?php selected($resistencia, 'Muito Alta'); ?>>
          <?php _e('Muito Alta', 'tradeexpansion'); ?></option>
      </select>
    </div>
  </div>
