...
$sheet_id = 'AKfycbzArdgH2Pwc7PG9VtC0GbNSgSaMvzogE7N6oNiST4ANpKE0tthsnvR2nScirJp7X826'; // Cole o ID da sua planilha aqui
?>

<section data-tab-panel="financial" class="space-y-6 <?php echo $active_tab === 'financial' ? '' : 'hidden'; ?>"
  x-data="financialDashboard()" x-init="loadFinancialData()">
  <!-- CABEÇALHO -->
  <div class="flex items-center justify-between">
    <div>
      ...
      <p class="text-sm text-secondary/70 mt-1">
        <?php esc_html_e('Control de pagos, créditos y plazos', 'tradeexpansion'); ?></p>
    </div>
  ...
  <div class="bg-white rounded-lg shadow-md overflow-hidden">
    <div class="p-6 border-b border-gray-200 bg-gradient-to-r from-primary to-secondary">
      <div class="flex items-center justify-between">
        ...
        <button @click="showFullSheet = !showFullSheet"
      ...
      <table class="w-full">
        <thead class="bg-gray-50">
          <tr>
            ...
            <th class="px-4 py-3 text-center text-xs font-semibold text-secondary uppercase tracking-wider">Vencimiento
            </th>
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          <template x-for="(row, index) in financialData" :key="index">
            <tr class="hover:bg-gray-50 transition">
              ...
              <td class="px-4 py-4 text-sm font-semibold text-secondary text-right"
                x-text="'$' + formatCurrency(row.VALOR)"></td>
              <td class="px-4 py-4 text-sm text-secondary text-right"
                x-text="row.ADV ? '$' + formatCurrency(row.ADV) : '-'"></td>
              <td class="px-4 py-4 text-sm text-center">
                <span class="px-2 py-1 rounded-full text-xs font-medium"
                  :class="row.PRAZO ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-600'"
                  x-text="row.PRAZO || 'N/A'"></span>
              </td>
              ...
              <td class="px-4 py-4 text-center">
                <span class="px-3 py-1 inline-flex text-xs font-semibold rounded-full"
                  ...
                  x-text="row['FECHA PAGO'] || 'Pendiente'"></span>
              </td>
  ...
  <!-- MODAL: NOVO PEDIDO -->
  <div x-show="showNewOrderModal" x-cloak @click.away="showNewOrderModal = false"
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p class="text-white/70 text-sm"><?php esc_html_e('Complete los datos del pedido', 'tradeexpansion'); ?>
                </p>
              </div>
            </div>
        ...
        <form @submit.prevent="submitNewOrder" class="p-6 space-y-5">
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" x-model="newOrder.proveedor"
            ...
            <div>
              ...
              <input type="text" x-model="newOrder.invoice"
                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition"
          ...
          <div class="grid grid-cols-3 gap-4">
            <div>
              ...
              <input type="number" step="0.01" x-model="newOrder.valor"
                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition"
            ...
            <div>
              ...
              <input type="number" step="0.01" x-model="newOrder.adv"
                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition"
                placeholder="0.00" />
            </div>
            ...
            <div>
              ...
              <input type="text" x-model="newOrder.prazo"
                class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition"
                placeholder="30 días" />
            </div>
          </div>
          ...
          <div>
            ...
            <input type="date" x-model="newOrder.vencimiento"
              class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition"
              required />
          </div>
          ...
          <div>
            ...
            <textarea x-model="newOrder.documentos" rows="3"
              ...
              placeholder="Notas, links de documentos, etc."></textarea>
          </div>
