...
// Sprint 2: role legada 'cliente' substituída por 'te_cliente' (ver client-portal/includes/permissions.php).
...
function te_client_portal_user_is_allowed($user)
{
  ...
  $allowed_roles = ['te_cliente', 'te_vendedor', 'administrator'];
...
function te_client_portal_is_cliente_user($user_id)
{
  ...
  return in_array('te_cliente', (array) $user->roles, true);
}
