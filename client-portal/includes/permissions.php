...
{
    // Sprint 2: NÃO chamar remove_role aqui. add_role é idempotente; chamar
    // remove_role apagaria as roles dos usuários atribuídos toda vez que o tema
    // é reativado. Se precisar atualizar capabilities, use $role->add_cap()/remove_cap().
