...
app = Flask(__name__)
CORS(app) # Permite o widget do site realizar requisições

client = genai.Client(api_key=os.getenv("GEMINI_API_KEY"))

# Carrega a base de dados em memória uma única vez ao iniciar a API
try:
    print("Carregando base de conhecimento do RAG...")
    base_conhecimento = carregar_base_de_conhecimento()
    print("Base de conhecimento carregada!")
except Exception as e:
    print("Erro ao inicializar base_conhecimento:", e)
...
def chat():
    ...
    # Buscar trechos relevantes nos documentos da Trade Expansion via RAG
    contexto_docs = ""
    if base_conhecimento:
        try:
            ...
            print("Aviso: Falha ao buscar similaridade no FAISS:", e)
...
By understanding this context, you can answer “why” questions, not just “what” questions. You can explain why inspection is important, why we are a valuable partner, and why Brazil is a top choice for ornamental stones. This knowledge is your foundation.
    ...
    try:
        ...
        mensagem_formatada = f"Documentação Técnica de Apoio:\n{contexto_docs}\n\nMensagem do usuário: {user_message}" if contexto_docs else user_message
        response = client.models.generate_content(
            model="gemini-2.0-flash",
            contents=[context, mensagem_formatada]
        )
