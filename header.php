...
<body <?php body_class("bg-primary text-text font-volk relative"); ?>>
  ...
  <!-- HEADER -->
  <header id="teHeader"
    class="bg-secondary text-custom1 px-8 py-4 shadow-md relative flex justify-between items-center">
    ...
    <nav id="menu"
      ...
      <a href="<?php echo is_front_page() ? '#sobre' : esc_url(home_url('/#sobre')); ?>"
        class="block md:inline hover:text-accent transition duration-200">Sobre</a>
      <a href="<?php echo is_front_page() ? '#servicos' : esc_url(home_url('/#servicos')); ?>"
        class="block md:inline hover:text-accent transition duration-200">Serviços</a>
      <a href="<?php echo esc_url(home_url('/contato')); ?>"
        class="block md:inline hover:text-accent transition duration-200">Contato</a>
    </nav>
    <!-- LOADING SCREEN -->
